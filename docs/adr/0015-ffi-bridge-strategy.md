...
## Addendum: frb-generated `unsafe` in `sdk/nostos_flutter/rust` (2026-07-12)

The Flutter SDK's glue crate (`sdk/nostos_flutter/rust`) is generated by
...
(which lets `nostos-ffi-wasm` keep `#![forbid(unsafe_code)]`), this is inherent
